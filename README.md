...
* **Missing Value Imputation:** * Filled with `0`: `v18q1` (tablets), `v2a1` (monthly rent), `rez_esc` (years behind in school).
...
* **Aggregated Features include:** * `mean`: Average education (`meaneduc`), Age demographics.
